...
DATA_FILES = [
	('/opt/extras.ubuntu.com/antiviral/bin',glob.glob('bin/*')),
	('/opt/extras.ubuntu.com/antiviral/share/antiviral',glob.glob('src/*')),
	('/usr/share/nautilus-python/extensions',['src/antiviral-extension.py']),
	('/opt/extras.ubuntu.com/antiviral/share/antiviral',['debian/changelog']),	
	('/opt/extras.ubuntu.com/antiviral/share/pixmaps',['data/antiviral.svg']),
	('/usr/share/applications',['data/antiviral.desktop'])
	]
...
class install_data(_install_data):
	def run(self):
		for lang in os.listdir('build/locale-langpack/'):
			lang_dir = os.path.join('/opt/extras.ubuntu.com/antiviral/share', 'locale-langpack', lang, 'LC_MESSAGES')
